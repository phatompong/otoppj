...
<div class="row"><!-- row no: 1 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <h1 class="page-header"> แผงควบคุมระบบหลังร้าน </h1>
        
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li class="active"><!-- active begin -->
            
                <i class="fa fa-dashboard"></i> การจัดการระบบ
        ...
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> การสั่งซื้อใหม่
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="index.php?view_orders"><!-- a href begin -->
                        ...
                        ดูการสั่งซื้อทั้งหมด <i class="fa fa-arrow-circle-right"></i>
