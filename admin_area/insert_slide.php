    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> แผงควบคุม / เพิ่มข่าวประชาสัมพันธ์
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> เพิ่มข่าวประชาสัมพันธ์
...
<!-- ----------------------------------------------------------------- -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input type="submit" name="submit" value="เพิ่มข่าว" class="btn btn-primary form-control">
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if($count<4){
            ...
            echo "<script>alert('ข่าวประชาสัมพันธ์ของคุณถูกเพิ่มเรียบร้อยแล้ว')</script>";
            
            echo "<script>window.open('index.php?view_slides','_self')</script>";
            
        }else{
            
           echo "<script>alert('คุณได้เพิ่มรูปภาพเดียวกันไปก่อนหน้านี้แล้ว')</script>"; 
