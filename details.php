                       ...
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">ปริมาณสินค้า</label>
                               ...
                               <p class="price"><?php echo $pro_price; ?> บาท </p>
                               
                               <p class="text-center buttons"><button class="btn btn-primary i fa fa-shopping-cart"> เพิ่มใส่ตะกร้า</button></p>
